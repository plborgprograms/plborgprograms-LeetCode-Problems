ArrayList<LinkedList<Integer>> allSequences(TreeNode node)
{
	...
	//weave toger each list from the left and right sides. */
...
/*
	Weave lists togerther in all possible ways. This algorithm works by removing the head from one
...
void weaveLists(LinkedList<Integer> first, LinkedList<Integer> second, ArrayList<LinkedList<Integer>> results, LinkedList<Integer> prefix)
{
	...
	//Do the same thing with second, damaging and then restoring the listint headSecond = second.removeFirst();
